...
def dump_trace_entries(filename, trace_entry_addrs):
    """dump_trace_entries
...
"""
To use this, create a new GHIDRA struct named "TraceEntry" and this layout:
...
def main():
    ...
    if len(te_list) == 0:
        print("ERROR: no TraceEntry struct found in the type system. See the code comments")
        return
    ...
    # dump_trace_entries("trace-entries.txt", trace_entry_addrs); return
